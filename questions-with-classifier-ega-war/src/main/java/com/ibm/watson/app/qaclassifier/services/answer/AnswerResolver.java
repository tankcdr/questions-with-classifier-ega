...
/**
 * An answer resolver resolves the payload from the NL Classifier Service 
 * into an answer suitable for use in the application
 */
public interface AnswerResolver {
    Answer resolve(NLClassifiedClass classifiedClass) throws ResolutionException;
}
